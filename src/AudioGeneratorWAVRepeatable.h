...
#ifndef _AUDIOGENERATORWAVREPEATABLE_H
#define _AUDIOGENERATORWAVREPEATABL_H

#include "AudioGenerator.h"

class AudioGeneratorWAVRepeatable : public AudioGenerator
{
  public:
    AudioGeneratorWAVRepeatable();
    virtual ~AudioGeneratorWAVRepeatable() override;
  ...
  private:
    ...
    bool GetBufferedDataRepeatable(int bytes, void *dest);
    bool ReadWAVInfo();
